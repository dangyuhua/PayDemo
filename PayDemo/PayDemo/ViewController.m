...
- (void)viewDidLoad {
    ...
    btn1.frame = CGRectMake(30, 50, self.view.bounds.size.width-60, 50);
    ...
    btn2.frame = CGRectMake(30, 150, self.view.bounds.size.width-60, 50);
